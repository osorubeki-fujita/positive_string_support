describe String do
  it "is converted by PositiveStringSupport::StringExt\#convert_meta_character_in_regexp" do
...
=end
  ...
  it "is converted by PositiveStringSupport\#convert_comma_between_number_to_dot" do
